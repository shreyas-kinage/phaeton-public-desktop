...
import { PrimaryButton, TertiaryButton } from '@tools/buttons';
import Illustration from '@tools/illustration';
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    const getMailReference = () => {
      ...
      const subject = `User Reported Error - Phaeton-Desktop-v.1.0`; // eslint-disable-line no-undef
