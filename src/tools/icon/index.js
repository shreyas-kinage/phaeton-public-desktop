...
import phaetonChat from "../../assets/images/icons/phaeton-chat.svg";
import phaetLogo from "../../assets/images/phaet-logo-v2.svg";
import phaetonLogoDark from "../../assets/images/phaet-logo-dark.svg";
import phaetonLogoWhite from "../../assets/images/phaet-logo-white-v2.svg";
import logout from "../../assets/images/icons/logout.svg";
import logoutActive from "../../assets/images/icons/logout-active.svg";
import phaeIcon from "../../assets/images/icons/icon-phae.svg";
...
import phaetonIcon from "../../assets/images/icons/phaeton-icon.svg";
...
const unlock = "fas fa-unlock-alt";
const vote = "fas fa-user-check";
export const icons = {
  academy,
  academyActive,
  alertIcon,
...
const Icon = ({ name, noTheme, icon, ...props }) => {
  const theme = useTheme();
  const src =
    theme === "dark" && !noTheme && icons[`${name}Dark`]
      ? icons[`${name}Dark`]
      : icons[name];
  return icon ? <i className={name} /> : <img src={src} {...props} />;
};
